...
import { ChessLessonView } from "./Lesson";
import { ChessPlayView } from "./Play";
import { ChessPuzzleView } from "./Puzzle";
...
export default function ChessIndex() {
  ...
  useEffect(() => {
    ...
    fetch(`${baseUrl}/api/chess-corpus`)
      ...
      .catch(err => {
        console.error("Error connecting to chess asset stream:", err);
      })
  ...
  return (
    <div className="w-full flex flex-col gap-4">
      {/* Render Main Content Routing Layout */}
      {(() => {
        // ── /chess ──────────────────────────────────────────────────────────
